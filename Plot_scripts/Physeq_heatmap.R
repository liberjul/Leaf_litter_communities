...
phy_otu_table <- otu_table(otu_dat_wo_negs, taxa_are_rows = T) # Make phyloseq object from OTU table
taxa_table <- as.matrix(read.csv("./clustered_OTU_ESV/allrank_otus_R1.fasta_classified_unite.csv")) # Read UNITE classified taxa table, convert to matrix
...
# ps_heatmap
ggsave("physeq_heatmap.png", ps_heatmap, width=12, height = 8, units="in") # Save plot
